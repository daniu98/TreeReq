...
export async function fetchMajor(majorId) {
  const res = await fetch(`/api/majors/${encodeURIComponent(majorId)}`);
...
export async function fetchMajorVisualTree(majorId) {
  const res = await fetch(`/api/majors/${encodeURIComponent(majorId)}/visual-tree`);
...
export async function fetchMajorPrereqTree(majorId) {
  const res = await fetch(`/api/majors/${encodeURIComponent(majorId)}/tree`);
